...
public final class Judge {
    ...
    private static final int balance = 800;
    private static int secondsRemaining = 15;
    public static LinkedList<Skill> log;

    public static void startFight(TimerTask timerTask) {
    ...
    public static Integer control(int sum){
        return balance - sum;
    }
